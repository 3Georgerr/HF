...
void setup() {
	...
	*/
	prvni=new HF(60, 6, NEO_GRB + NEO_KHZ800);
	druhy = new HF(90, 6, NEO_GRB + NEO_KHZ800);
	treti = new HF(240, 6, NEO_GRB + NEO_KHZ800);
	ctvrty = new HF(240, 6, NEO_GRB + NEO_KHZ800);
	paty = new HF(240, 6, NEO_GRB + NEO_KHZ800);
	sesty = new HF(240, 6, NEO_GRB + NEO_KHZ800);
